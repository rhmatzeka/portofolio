      ...
      <div className="contact-content">
        <motion.div className="contact-left" variants={itemUp}>
          ...
          <div className="contact-info">
            <a href="mailto:your@email.com" className="contact-info-item">
            ...
            <a href="https://github.com/yourusername" className="contact-info-item">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <a href="https://linkedin.com/in/yourusername" className="contact-info-item">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
