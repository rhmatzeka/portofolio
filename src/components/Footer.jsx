      ...
      <div className="footer-content">
        <div className="footer-top">
          <div className="footer-brand">
            <h3 className="footer-logo">Rahmat<span>.</span></h3>
          ...
          <div className="footer-links">
            ...
            <div className="footer-column">
              ...
              <a href="https://instagram.com/rhmat.dev" target="_blank" rel="noopener noreferrer">Instagram</a>
            ...
            <div className="footer-column">
              ...
              <a href="#">Solidity & Web3</a>
              <a href="#">Node.js & PostgreSQL</a>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">© {currentYear} Rahmat Eka Satria. All rights reserved.</p>
          <div className="footer-social-icons">
            <a href="https://github.com/rhmatzeka" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <a href="https://instagram.com/rhmat.dev" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
